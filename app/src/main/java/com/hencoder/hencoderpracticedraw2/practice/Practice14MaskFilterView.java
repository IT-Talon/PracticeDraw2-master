...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    MaskFilter filter1 = new BlurMaskFilter(10, BlurMaskFilter.Blur.NORMAL);
    MaskFilter filter2 = new BlurMaskFilter(10, BlurMaskFilter.Blur.INNER);
    MaskFilter filter3 = new BlurMaskFilter(10, BlurMaskFilter.Blur.OUTER);
    MaskFilter filter4 = new BlurMaskFilter(10, BlurMaskFilter.Blur.SOLID);
